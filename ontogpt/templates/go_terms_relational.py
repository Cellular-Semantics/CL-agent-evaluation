...
class ProteinToGORelationship(Triple):
    ...
    subject: Optional[str] = Field(
        None,
        description="""The protein participating in the relationship, for example: Klp61F, GATA binding protein 3, S-formylglutathione hydrolase""",
    )
    predicate: Optional[str] = Field(
        None, description="""The relationship type, usually HAS ANNOTATION."""
    )
    object: Optional[str] = Field(
        None,
        description="""The Gene Ontology term participating in the relationship, for example: cytosol, plasma cell differentiation, small-subunit processome""",
    )
    qualifier: Optional[str] = Field(
        None,
        description="""A qualifier for the statements, e.g. \"NOT\" for negation""",
    ...
    subject_qualifier: Optional[str] = Field(
        None, description="""An optional qualifier or modifier for the protein."""
    )
    object_qualifier: Optional[str] = Field(
        None, description="""An optional qualifier or modifier for the GO term."""
    )
